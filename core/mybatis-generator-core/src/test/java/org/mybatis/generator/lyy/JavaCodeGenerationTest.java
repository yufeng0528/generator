 ...
 */
package org.mybatis.generator.lyy;
...
public class JavaCodeGenerationTest {
    ...
    public static List<GeneratedJavaFile> generateJavaFiles() throws Exception {
        ...
        generatedFiles.addAll(generateJavaFilesMybatis2());
    ...
    private static List<GeneratedJavaFile> generateJavaFilesMybatis2() throws Exception {
        createDatabase2();
        return generateJavaFiles("/scripts/lyy_test.xml");
    }
    ...
    public static void createDatabase2() throws Exception {
        ...
        SqlScriptRunner scriptRunner = new SqlScriptRunner(JavaCodeGenerationTest.class.getResourceAsStream("/scripts/CreateTestDB.sql"), "com.mysql.jdbc.Driver", "jdbc:mysql://127.0.0.1:3306/market?useUnicode=true", "root", "yiguokeji01db");
        scriptRunner.executeScript();
    }
}
